            ...
            <div class="signin-container col-12 row">
                ...
                <div class="signup-modal col-sm-12    col-md-7 col-lg-6 col-xxl-4">
                    ...
                    <div class="signin-heading">
                        <ul class="ul-list">
                            <li><a href="signin-mobile" class="deactive"> Sign In</a>
                            </li>
                            <div class="verticalline"> </div>
                            <li><a href="signup-mobile" class="active">Sign Up</a> </li>
                        </ul>
                    </div>
                    ...
                    <div class=" method">
                        <div class="method-text">
                            <span class="deactive"><a href="signup-email">Email</a></span>

                            <span><a href="signup-mobile" class="active">Mobile</a></span>
                        </div>
                    </div>
                    ...
                    <div class="bottom-form row">
                        <div class="link-to">
                            ...
                            <a href="/user/signin-mobile">Sign In</a>
                        </div>
                    </div>
                </div>
                <!-- right -->
