            ...
            <div class="main-right">
                <div class="content-profile">
                    ...
                    <div class="statistics">
                        ...
                        <div class="total-row">
                            <div class="row">
                                <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                    <p class="title-statist my-3 group-text-color">30d Trades</p>
                                    <p class="value-statist">80 Time (s)</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                    <p class="title-statist my-3 group-text-color">Completion Rate</p>
                                    <p class="value-statist">100%</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                    <p class="title-statist my-3 group-text-color">Avg. Release Time</p>
                                    <p class="value-statist">5 mins</p>
                                </div>
                                <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                    <p class="title-statist my-3 group-text-color">Avg. Pay Time</p>
                        ...
                        <div id="show-more-content">
                            <div class="total-row">
                                <div class="row">
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                        <p class="title-statist my-3 group-text-color">Registered</p>
                                        <p class="value-statist">35 days</p>
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                        <p class="title-statist my-3 group-text-color">Positive Feedback</p>
                                        <p class="value-statist">98%</p>
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                        <p class="title-statist my-3 group-text-color">Negative Feedback</p>
                                        <p class="value-statist">2%</p>
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 text-center">
                                        <p class="title-statist my-3 group-text-color">All Trades</p>
                        ...
                        <div>
                            <div class="row">
                                <div
                                    ...
                                    <label class="" for="">My Referral Link:</label>
                                    <span id="valueText1"
                                        value="https://www.w3schools.com/howto/howto_js_copy_clipboard.asp">
                                        https://www.w3schools.com </span>
                                ...
                                <div
                                    ...
                                    <label for="">My Referral ID:</label>
                    ...
                    <div class="activity">
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 location">Web</div>
                            <div
