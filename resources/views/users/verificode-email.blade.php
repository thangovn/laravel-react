            ...
            <div class="signin-container col-12 row">
                ...
                <div class="signin-modal col-sm-12    col-md-7 col-lg-6 col-xxl-4 ">
                    ...
                    <div class="authenticator-text">
                        <p class="active">Enter Verified Code</p>
                        <p class="description">The verified code has been sent to your email
                    ...
                    <div class="signin-form " id="signin">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input class="input-signin" type="text" id="user" placeholder="Enter Verified Code....">
                            <label class="label">Verified Code</label>
                        </div>
                        <div class="action-wrapper">

                            <button class="pm-prinary sign-in-button">SIGN IN</button>
                        </div>
                    </div>
                </div>
                <!-- right -->
