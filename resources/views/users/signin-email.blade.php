                ...
                <div class="signin-modal col-sm-12    col-md-7 col-lg-6 col-xxl-4 ">
                    ...
                    <div class="signin-heading">
                        <ul class="ul-list">
                            ...
                            <li class="deactive"><a href="signup-email" class=" deactive"> Sign Up</a></li>
                        </ul>
                    </div>

                    <div class=" method">
                        <div class="method-text">
                            <span><a href="signin-email" class="active">Email</a></span>

                            <span><a href="signin-mobile" class="deactive">Mobile</a></span>
                        </div>
                    </div>
                    ...
                    <div class="bottom-form row">
                        <div class="link-to">
                            ...
                            <a href="/user/signin">Privacy Poilicy</a>
                        </div>
                    </div>
                </div>
                <!-- right -->
